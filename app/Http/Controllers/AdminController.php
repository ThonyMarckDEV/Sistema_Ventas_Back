...
public function listarProductos()
{
    ...
    public function updatePaymentStatus(Request $request, $idPago)
    {
        ...
        // Si el estado es "completado", descontar el stock, generar la boleta y enviar el correo
        if ($estado_pago === 'completado') {
            $pedido = Pedido::with('detalles')->find($idPedido);
            ...
            if ($pedido) {
                ...
                if ($usuario) {
                    ...
                    // Preparar los detalles del pedido para el correo y la boleta
                    $detallesPedido = [];
                    $total = 0;
                    ...
                    // Generar la boleta en PDF y guardar en la ruta especificada
